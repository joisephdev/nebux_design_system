...
as NbxFormType,border: freezed == border ? _self.border : border // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _NbxInputParameters() when $default != null:
return $default(_that.hintText,_that.labelText,_that.isRequired,_that.inputType,_that.context,_that.floatingLabelBehavior,_that.showSuffixIcon,_that.obscureText,_that.isReadOnly,_that.isEnabled,_that.showEyeIcon,_that.showCancelIcon,_that.autoDisposeController,_that.forceShowSuffixIcon,_that.autovalidateMode,_that.requiredErrorMessage,_that.validator,_that.customValidator,_that.minLines,_that.maxLines,_that.maxLength,_that.suffixIcon,_that.prefixIcon,_that.fillColor,_that.textInputAction,_that.controller,_that.suffixOnPressed,_that.onSubmitted,_that.onChanged,_that.inputFormatters,_that.formType,_that.border,_that.enabledBorder,_that.focusedBorder,_that.errorBorder,_that.focusedErrorBorder,_that.disabledBorder,_that.onTap);case _:
  return orElse();
...
@override
int get hashCode => Object.hashAll([runtimeType,hintText,labelText,isRequired,inputType,context,floatingLabelBehavior,showSuffixIcon,obscureText,isReadOnly,isEnabled,showEyeIcon,showCancelIcon,autoDisposeController,forceShowSuffixIcon,autovalidateMode,requiredErrorMessage,validator,customValidator,minLines,maxLines,maxLength,suffixIcon,prefixIcon,fillColor,textInputAction,controller,suffixOnPressed,onSubmitted,onChanged,const DeepCollectionEquality().hash(_inputFormatters),formType,border,enabledBorder,focusedBorder,errorBorder,focusedErrorBorder,disabledBorder,onTap]);
